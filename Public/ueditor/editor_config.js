...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"/Uploads/upload/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:440                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace','help','fortitle','autopermu']
        ]
        //当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值为准
        ,labelMap:{
            'anchor':'', 'undo':'','fortitle':'设为标题'
        }
        //webAppKey
        ...
        ,initialFrameWidth:460  //初始化编辑器宽度,默认1000
        ...
        //,autoClearEmptyNode : true //getContent时，farme是否删除空的inlineElement节点（包括嵌套的情况）
