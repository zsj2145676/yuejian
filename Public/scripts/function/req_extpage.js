var req_ext={
    ...
    ajaxDeleteListSNT:function(ids,success,error){
        $.ajax({
            type    : "POST",
            url     : "/h.php?m=Message&a=deleteAll",
            async : false,
            data : {ids:ids},
            success : function(data) {
                success && success(data);
